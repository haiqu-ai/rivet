...
<picture>
  ...
  <figcaption>
    <i>
    Figure 1: This plot visualizes the difference in transpilation time between Rivet and a standard transpiler, where a massive advantage is seen through Rivet’s implementation. The example is presented for shadow tomography for a state generated by the litmus circuit. Check <a href=nonebook](https://github.com/haiqu-ai/rivet/blob/main/examples/shadows/shadow_state_tomography.ipynb)">Shadow State Tomography</a>  for more details. 
    </i>
  </figcaption>
</picture>k
</p>
